...
class TbJsonCheckBoxColumn extends CCheckBoxColumn
{
	...
	public function renderHeaderCell()
	{
		if ($this->grid->json) {
			...
			if ($this->grid->json) {
				return CMap::mergeArray($this->headerHtmlOptions, array('content' => $this->renderHeaderCellContent()));
			}
		}
	...
	public function renderDataCell($row)
	{
		...
		if ($this->grid->json) {
			return CMap::mergeArray($options, array('content' => $this->renderDataCellContent($row, $data)));
		}
