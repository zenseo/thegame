					...
					if (o.children) {
						...
						if (isValArray) {
							if ($.grep(value,function (v) {
								return v == (
									o && typeof o === 'object' ? o[valueProp] : o
									);
							}).length) {
								result.push(o);
							}
		...
		Editable.prototype = {
			...
			save: function (e, params) {
				...
				if (this.options.unsavedclass) {
					...
					sent = sent || (
						this.options.savenochange && this.input.value2str(this.value) !== this.input.value2str(params.newValue)
						);
	...
	function ($) {
		...
		$.fn.combodate = function (option) {
			...
			return this.each(function () {
				...
				if (!data) {
					$this.data('combodate', (
						data = new Combodate(this, options)
						));
				}
		...
		Datepicker.prototype = {
			...
			fillDow: function () {
				...
				while (dowCnt < this.o.weekStart + 7) {
					html += '<th class="dow">' + dates[this.o.language].daysMin[(
						dowCnt++
						) % 7] + '</th>';
				}
				html += '</tr>';
