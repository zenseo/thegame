	...
	function (window, document, $, undefined) {
		...
		Notification = (
			function () {
				...
				Notification.prototype.setElementPosition = function () {
					...
					gap = Math.max(0, this.options.gap - (
						this.options.arrowShow ? arrowSize : 0
						));
				...
				Notification.prototype.getPosition = function () {
					...
					if (pos.length === 1 || (
						...
						pos[1] = (
							_ref5 = pos[0], __indexOf.call(hAligns, _ref5) >= 0
							) ? 'm' : 'l';
					}
					if (pos.length === 2) {
						pos[2] = pos[1];
		...
		$(function () {
			...
			return $(document).on('click notify-hide', "." + pluginClassName + "-wrapper", function (e) {
				...
				if (inst && (
					inst.options.clickToHide || e.type === 'notify-hide'
					)) {
