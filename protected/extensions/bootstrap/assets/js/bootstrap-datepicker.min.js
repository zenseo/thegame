	...
	function (e) {
		...
		i.prototype = {constructor: i, _process_options: function (t) {
			...
			if (n.startDate !== -Infinity) {
				if (!!n.startDate) {
					if (n.startDate instanceof Date) {
			...
			if (!e.isArray(n.daysOfWeekDisabled)) {
			...
			if (d === "top") {
				...
				p -= r + parseInt(this.picker.css("padding-top"));
			}
			...
			if (n) {
				...
				if (e.getTime() !== this.date.getTime()) {
