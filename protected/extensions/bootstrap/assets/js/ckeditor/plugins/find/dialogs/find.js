...
(
	function () {
		function y(c) {
			return c.type == CKEDITOR.NODE_TEXT && 0 < c.getLength() && (
				!o || !c.isReadOnly()
				)
		}
		...
		function s(c) {
			return!(
				c.type == CKEDITOR.NODE_ELEMENT && c.isBlockBoundary(CKEDITOR.tools.extend({}, CKEDITOR.dtd.$empty, CKEDITOR.dtd.$nonEditable))
				)
		}
		...
		var o, t = function () {
			...
			function q(a) {
				...
				b && b.type == CKEDITOR.SELECTION_NONE && !a ? (
			...
			l.prototype = {next: function () {
				...
				back: function () {
					...
					if (b && a && 0 < this.offset) {
						...
						for (b = null; !b && !(
							b = this._.walker[a ? "previous" : "next"].call(this._.walker), this._.matchWord && !b || this._.walker._.end
							);) {
							;
						}
						this.offset = (
			...
			r.prototype = {toDomRange: function () {
				...
				d = (
					b = d[d.length - 1]
					) && b.textNode ? new l(n(b)) : this._.walker;
				return new r(d, a)
			}, getCursors: function () {
			...
			var z = /[.,"'?!;: \u0085\u00a0\u1680\u280e\u2028\u2029\u202f\u205f\u3000]/, x = function (a) {
				...
				return f && !A ? (
					this.searchRange = q(1), this.matchRange = null, arguments.callee.apply(this, Array.prototype.slice.call(arguments).concat([!0]))
					) :
					!1
				...
				if (this.matchRange && this.matchRange.isMatched() && !this.matchRange._.isReplaced && !this.matchRange.isReadOnly()) {
					...
					b.insertNode(d);
					i || (
						j.selectRanges([b]), c.fire("saveSnapshot")
						);
			...
			return{title: f.title, resizable: CKEDITOR.DIALOG_RESIZE_NONE, minWidth: 350, minHeight: 170, buttons: [CKEDITOR.dialog.cancelButton], contents: [
				...
				{id: "replace", label: f.replace, accessKey: "M", elements: [
					...
					{type: "hbox", widths: ["230px", "90px"], children: [
						...
						{type: "button", id: "btnReplaceAll", align: "left", style: "width:100%", label: f.replaceAll, isChanged: !1, onClick: function () {
							...
							e.replaceCounter ? (
								alert(f.replaceSuccessMsg.replace(/%1/, e.replaceCounter)), c.fire("saveSnapshot")
								) : alert(f.notFoundMsg)
						}}
					]},
				...
				this[(
					"find" ==
						g && this._.editor.readOnly ? "hide" : "show"
					) + "Page"]("replace")
			}, onHide: function () {
				var a;
				e.matchRange && e.matchRange.isMatched() && (
					e.matchRange.removeHighlight(), c.focus(), (
