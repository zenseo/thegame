...
CKEDITOR.dialog.add("cellProperties", function (f) {
	...
	return{title: c.title, minWidth: CKEDITOR.env.ie && CKEDITOR.env.quirks ? 450 : 410, minHeight: CKEDITOR.env.ie && (
				...
				{type: "vbox", padding: 0, children: [
					...
					{type: "hbox", padding: 0, widths: ["60%", "40%"],
						children: [
							...
							{type: "button", id: "borderColorChoose", "class": "colorChooser", label: c.chooseColor, style: (
								k ? "margin-right" : "margin-left"
								) + ": 10px", onLoad: function () {
