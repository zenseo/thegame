	...
	function () {
		var r = function (c, j) {
				...
				w = function () {
					...
					if ("check" == b) {
						if (!a.userlockRatio && "true" == d.getCustomData("isReady")) {
							...
							a.lockRatio = !1;
							!e && !c ? a.lockRatio = !0 : !isNaN(d) && !isNaN(f) && Math.round(d) == Math.round(f) && (
								a.lockRatio = !0
								)
						}
					}
			...
			return{title: c.lang.image["image" == j ? "title" : "titleButton"], minWidth: 420, minHeight: 360, onShow: function () {
				...
				this.firstLoad = !0;
				this.addLink = !1;
				var a = this.getParentEditor(), b = a.getSelection(), d = (
				...
				if (d) {
					...
					if (1 == c.count()) {
						...
						if ("img" == g || "input" == g) {
							this.imageElement = c.getItem(0), "img" == this.imageElement.getName() ? this.imageEditMode = "img" : "input" == this.imageElement.getName() && (
				...
				if (this.imageEditMode) {
					...
					"image" ==
						j ? this.imageElement = c.document.createElement("img") : (
						this.imageElement = c.document.createElement("input"), this.imageElement.setAttribute("type", "image")
				...
				this.imageEditMode ? !this.linkEditMode && this.addLink ? (
					...
					) : this.addLink ? this.linkEditMode ? c.insertElement(this.imageElement) : (
				...
				{id: "info", label: c.lang.image.infoTab, accessKey: "I", elements: [
						...
						{type: "hbox", widths: ["280px",
							...
							{id: "txtUrl", type: "text", label: c.lang.common.url, required: !0, onChange: function () {
								...
								a == f && (
									...
									b.setAttribute("src", ""), b.removeAttribute("src")
									)
					...
					{id: "txtAlt", type: "text", label: c.lang.image.alt, accessKey: "T", "default": "", onChange: function () {
						...
						a == f ? (
							this.getValue() || this.isChanged()
							) && b.setAttribute("alt", this.getValue()) : 4 == a ? b.setAttribute("alt", this.getValue()) : 8 == a && b.removeAttribute("alt")
					}},
					{type: "hbox", children: [
							...
							{type: "hbox", widths: ["50%", "50%"], children: [
								{type: "vbox", padding: 1, children: [
									{type: "text", width: "40px", id: "txtWidth", label: c.lang.common.width, onKeyUp: w, onChange: function () {
										...
										a == f ? (
											c ? b.setStyle("width", CKEDITOR.tools.cssLength(c)) :
												b.removeStyle("width"), !d && b.removeAttribute("width")
											) : 4 == a ? c.match(k) ? b.setStyle("width", CKEDITOR.tools.cssLength(c)) : (
									...
									{type: "text", id: "txtHeight", width: "40px", label: c.lang.common.height, onKeyUp: w, onChange: function () {
										...
										var c = this.getValue();
										a == f ? (
											c ? b.setStyle("height", CKEDITOR.tools.cssLength(c)) : b.removeStyle("height"), !d && b.removeAttribute("height")
											) : 4 == a ? c.match(k) ? b.setStyle("height", CKEDITOR.tools.cssLength(c)) : (
							...
							{type: "vbox", padding: 1, children: [
								{type: "text", id: "txtBorder", width: "60px", label: c.lang.image.border, "default": "", onKeyUp: function () {
									...
									a == f || 4 == a ? (
										...
										b.removeAttribute("border"), b.removeStyle("border-width"), b.removeStyle("border-style"),
								...
								{type: "text", id: "txtHSpace", width: "60px", label: c.lang.image.hSpace, "default": "", onKeyUp: function () {
									...
									a == f || 4 == a ? (
										isNaN(e) ? !e && this.isChanged() && (
											b.removeStyle("margin-left"), b.removeStyle("margin-right")
											) : (
											b.setStyle("margin-left", CKEDITOR.tools.cssLength(e)), b.setStyle("margin-right", CKEDITOR.tools.cssLength(e))
											), !c && a == f && b.removeAttribute("hspace")
										) : 8 == a && (
										b.removeAttribute("hspace"), b.removeStyle("margin-left"), b.removeStyle("margin-right")
										)
								}},
								{type: "text", id: "txtVSpace", width: "60px", label: c.lang.image.vSpace, "default": "",
									...
									a == f || 4 == a ? (
										...
										b.removeAttribute("vspace"), b.removeStyle("margin-top"), b.removeStyle("margin-bottom")
										)
								}},
						...
						{type: "vbox", height: "250px", children: [
							{type: "html", id: "htmlPreview", style: "width:95%;", html: "<div>" + CKEDITOR.tools.htmlEncode(c.lang.common.preview) + '<br><div id="' + m + '" class="ImagePreviewLoader" style="display:none"><div class="loading">&nbsp;</div></div><div class="ImagePreviewBox"><table><tr><td><a href="javascript:void(0)" target="_blank" onclick="return false;" id="' + A + '"><img id="' + z + '" alt="" /></a>' + (
					...
					{type: "hbox", widths: ["50%", "50%"], children: [
						...
						{type: "text", id: "txtGenTitle", label: c.lang.common.advisoryTitle, "default": "", onChange: function () {
							...
							commit: function (a, b) {
								a == f ? (
									this.getValue() || this.isChanged()
									) && b.setAttribute("title", this.getValue()) : 4 == a ? b.setAttribute("title", this.getValue()) : 8 == a && b.removeAttribute("title")
							}}
					]},
