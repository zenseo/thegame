...
CKEDITOR.dialog.add("form", function (a) {
	...
	return{title: a.lang.forms.form.title, minWidth: 350, minHeight: 200, onShow: function () {
		...
		b && (
			this.form = b, this.setupContent(b)
			)
	}, onOk: function () {
		var b, a = this.form, c = !a;
		c && (
			b = this.getParentEditor(), a = b.document.createElement("form"), !CKEDITOR.env.ie && a.append(b.document.createElement("br"))
			);
		c && b.insertElement(a);
