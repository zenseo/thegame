var swfobject = function () {
	...
	function E(a) {
		...
		if ((
			...
			typeof a.SetVariable != i ? b = a : (
				a = a.getElementsByTagName(r)[0]
				) && (
				b = a
				);
		}
	...
	function G(a, b, c, f) {
		...
		if (g) {
			...
			b.flashvars = typeof b.flashvars != i ? b.flashvars + (
				"&" + f
				) : f;
			e.ie && (
			...
			if (a = a.childNodes) {
				for (var c = a.length, f = 0; f < c; f++) {
					!(
						...
						) && 8 != a[f].nodeType && b.appendChild(a[f].cloneNode(!0));
				}
			}
		}
		return b
			...
			if (typeof a.id == i && (
				...
				for (h in a) {
					a[h] != Object.prototype[h] && (
						"data" == h.toLowerCase() ? b.movie = a[h] : "styleclass" == h.toLowerCase() ? o += ' class="' + a[h] + '"' : "classid" != h.toLowerCase() && (
							o += " " +
								h + '="' + a[h] + '"'
							)
						);
				...
				for (var k in a) {
					a[k] != Object.prototype[k] && (
						"styleclass" == k.toLowerCase() ? j.setAttribute("class", a[k]) : "classid" != k.toLowerCase() && j.setAttribute(k, a[k])
						);
				}
				for (o in b) {
	...
	(
		function () {
			e.w3 && (
				(
					typeof d.readyState != i && "complete" == d.readyState || typeof d.readyState == i && (
						d.getElementsByTagName("body")[0] || d.body
						)
					) && u(), s || (
					typeof d.addEventListener != i && d.addEventListener("DOMContentLoaded", u, !1), e.ie && e.win && (
						...
						s || (
							/loaded|complete/.test(d.readyState) ? u() : setTimeout(arguments.callee, 0)
							)
					}(), M(u)
					)
				)
	...
	return{registerObject: function (a, b, c, f) {
		...
		e.w3 && !(
			...
			t(b, !1), L(function () {
				...
				if (h && typeof h === r) {
					for (var q in h) {
						l.flashvars = typeof l.flashvars != i ? l.flashvars + (
							"&" + q + "=" + h[q]
							) : q + "=" + h[q];
					}
				}
		...
		if (A) {
			var a = n(O);
			a && w && (
				a.parentNode.replaceChild(w, a), B && (
					t(B, !0), e.ie && e.win && (
