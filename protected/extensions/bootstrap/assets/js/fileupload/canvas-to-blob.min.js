(
	function (a) {
		...
		var b = a.HTMLCanvasElement && a.HTMLCanvasElement.prototype, c = a.Blob && function () {
		...
		}(), e = a.BlobBuilder || a.WebKitBlobBuilder || a.MozBlobBuilder || a.MSBlobBuilder, f = (
			c || e
			...
			return i = a.split(",")[0].split(":")[1].split(";")[0], c ? new Blob([d ? g : f], {type: i}) : (
				j = new e, j.append(f), j.getBlob(i)
				)
		};
		a.HTMLCanvasElement && !b.toBlob && (
			b.mozGetAsFile ? b.toBlob = function (a, b) {
