...
(
	function (a) {
		a.Jcrop = function (b, c) {
			...
			function s(a) {
				return function (b) {
					return d.disabled ? !1 : a === "move" && !d.allowMove ? !1 : (
			...
			function t(a, b, c) {
				...
				d > b && b > 0 && (
					d = b, e = b / a.width() * a.height()
					), e > c && c > 0 && (
					e = c, d = c / a.height() * a.width()
					), T = a.width() / d, U = a.height() / e, a.width(d).height(e)
			}
			...
			function v(a) {
				...
				b.w > d.minSelect[0] && b.h > d.minSelect[1] ? (
					...
					) : bb.release(), bc.setCursor(d.allowSelect ? "crosshair" : "default")
			}
			...
			function bf(a, b) {
				...
				var s, u = function () {
					return function () {
						q += (
							100 - q
							) / r, k[0] = Math.round(c + q / 100 * m), k[1] = Math.round(e + q / 100 * n), k[2] = Math.round(f + q / 100 * o), k[3] = Math.round(g + q / 100 * p), q >= 99.8 && (
							q = 100
							), q < 100 ? (
							bh(k), t()
							) : (
			...
			function br(a) {
				d.allowResize ? a ? bb.enableOnly() : bb.enableHandles() : bb.disableHandles(), bc.setCursor(d.allowSelect ? "crosshair" : "default"), bb
					.setCursor(d.allowMove ? "move" : "default"), d.hasOwnProperty("trueSize") && (
					T = d.trueSize[0] / E, U = d.trueSize[1] / F
					), d.hasOwnProperty("setSelect") && (
					bg(d.setSelect), bb.done(), delete d.setSelect
					), ba.refresh(), d.bgColor != N && (
					bq(d.shade ? ba.getShades() : G, d.shade ? d.shadeColor || d.bgColor : d.bgColor), N = d.bgColor
					), O != d.bgOpacity && (
					O = d.bgOpacity, d.shade ? ba.refresh() : bb.setBgOpacity(O)
					), P = d.maxSize[0] || 0, Q = d.maxSize[1] || 0, R = d.minSize[0] || 0, S = d.minSize[1] || 0, d.hasOwnProperty("outerImage") && (
			...
			if (b.tagName == "IMG") {
				...
				D = A.css(z).show(), B = !1, d.shade === null && (
					d.shade = !0
					);
			}
			...
			var Z = function () {
				...
				return{createDragger: function (a) {
					return function (b) {
						return d.disabled ? !1 : a === "move" && !d.allowMove ? !1 : (
							e = l(D), W = !0, o(a, m(Z.cfilter(b)), !0), b.stopPropagation(), b.preventDefault(), !1
							)
					}
				...
				function m() {
					...
					return h === 0 && (
						...
						r = c, u = l / f, s = k < 0 ? b - u : b + u, s < 0 ? (
							s = 0, t = Math.abs((
								s - b
								) * f), r = j < 0 ? a - t : t + a
							) : s > F && (
							s = F, t = Math.abs(s - b) * f, r = j < 0 ? a - t : t + a
							)
						), r > a ? (
						r - a < g ? r = a + g : r - a > h && (
							r = a + h
				...
				function k() {
					b || (
						b = !0, c.insertBefore(D), g(), bb.setBgOpacity(1, 0, 1), H.hide(), l(d.shadeColor || d.bgColor, 1), bb.
				...
				function m() {
					b && (
						c.remove(), H.show(), b = !1, bb.isAwake() ? bb.setBgOpacity(d.bgOpacity, 1, 1) : (
				...
				function n(a, e) {
					b && (
						d.bgFade && !e ? c.animate({opacity: 1 - a}, {queue: !1, duration: d.fadeTime}) : c.css({opacity: 1 - a})
						)
				}
				...
				function i(a) {
					return a.preventDefault(), a.stopPropagation(), W && (
						W = !1, c(m(a)), bb.isAwake() && d.onSelect.call(bs, u(_.getFixed())), g(), b = function () {
						}, c = function () {
						}
						), !1
				}
				...
				function g(a, b, c) {
					d.allowMove && (
						_.moveOffset([b, c]), bb.updateVisible(!0)
				...
				return d.keySupport && (
					b.keydown(i).blur(f), h || !d.fixedSupport ? (
			...
			}), f.complete && a.isFunction(c) && (
				e.unbind(".jcloader"), c.call(f)
				)
